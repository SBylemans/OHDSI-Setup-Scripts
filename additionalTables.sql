...
create table {0}.heracles_analysis
(
  analysis_id integer,
...
create table {0}.heracles_results
(
...
create index hr_idx_cohort_id_first_res
  on {0}.heracles_results (cohort_definition_id, analysis_id, count_value, stratum_1)
;

create index hr_idx_cohort_id_analysis_id
  on {0}.heracles_results (cohort_definition_id, analysis_id)
;

create index hr_idx_cohort_def_id_dt
  on {0}.heracles_results (cohort_definition_id, last_update_time)
;

create index hr_idx_cohort_def_id
  on {0}.heracles_results (cohort_definition_id)
;

create table {0}.heracles_results_dist
(
  cohort_definition_id integer,
  analysis_id integer,
  stratum_1 varchar(255),
...
create index hrd_idx_cohort_id_first_res
  on {0}.heracles_results_dist (cohort_definition_id, analysis_id, count_value, stratum_1)
;

create index hrd_idx_cohort_id_analysis_id
  on {0}.heracles_results_dist (cohort_definition_id, analysis_id)
;

create index hrd_idx_cohort_def_id_dt
  on {0}.heracles_results_dist (cohort_definition_id, last_update_time)
;

create index hrd_idx_cohort_def_id
  on {0}.heracles_results_dist (cohort_definition_id)
;

create table {0}.heracles_heel_results
(
  cohort_definition_id integer,
  analysis_id integer,
...
create index hh_idx_cohort_id_analysis_id
  on {0}.heracles_heel_results (cohort_definition_id, analysis_id)
;

create table {0}.feas_study_result
(
...
create table {0}.feas_study_index_stats
(
  study_id integer not null,
  person_count bigint not null,
...
create table {0}.feas_study_inclusion_stats
(
  study_id integer not null,
...
create table {0}.cohort_inclusion
(
  cohort_definition_id integer not null,
  rule_sequence integer not null,
  name varchar(255),
...
create table {0}.cohort_inclusion_result
(
  cohort_definition_id integer not null,
  inclusion_rule_mask bigint not null,
  person_count bigint not null
...
create table {0}.cohort_inclusion_stats
(
  cohort_definition_id integer not null,
  rule_sequence integer not null,
  person_count bigint not null,
...
create table {0}.cohort_summary_stats
(
  cohort_definition_id integer not null,
...
create table {0}.ir_analysis_result
(
  analysis_id integer not null,
...
create table {0}.ir_analysis_strata_stats
(
  analysis_id integer not null,
  target_id integer not null,
  outcome_id integer not null,
...
create table {0}.ir_analysis_dist
(
  analysis_id integer not null,
  target_id integer not null,
  outcome_id integer not null,
...
create table {0}.cohort_features_dist
(
...
create table {0}.cohort_features
(
  cohort_definition_id bigint,
  covariate_id bigint,
  sum_value bigint,
...
create table {0}.cohort_features_ref
(
  cohort_definition_id bigint,
  covariate_id bigint,
...
create table {0}.cohort_features_analysis_ref
(
  cohort_definition_id bigint,
  analysis_id integer,
